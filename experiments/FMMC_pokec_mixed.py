...
def new_run_experiment_pokec_mixed(graphsize: str):
    ...
    if graphsize == "vssl1":
        region_categories = {
            ...
            'graph_dir_0': ["ceska republika, cz - kralovehradecky kraj",
                            ...
                            "ceska republika, cz - vysocina", ],
            # 2276 at 96%
            'graph_dir_1': ["presovsky kraj, velky saris",
                            "presovsky kraj, vysoke tatry",
                            "presovsky kraj, podolinec", ],
            # 36688 edges 93%
            'graph_dir_2': ['banskobystricky kraj, detva',
                            'banskobystricky kraj, filakovo',
                            'presovsky kraj, spisska bela',
                            'bratislavsky kraj, bratislava - dubravka'],
            # # 512 at 99,9 (1 connecting edge)%
            # 'graph_dir_1': ["trnavsky kraj, sastin-straze",
            #                 "ceska republika, cz - vysocina",
            #                 "bratislavsky kraj, svaty jur", ],
            # # 1247 at 90%
            # 'graph_dir_0': ["ceska republika, cz - budejovicky kraj",
            ...
            #                 "presovsky kraj, vysoke tatry",
            #                 "presovsky kraj, podolinec", ],
            # unconeccted aber nur 200 edges
            # 'graph_dir_0': ["trnavsky kraj, sastin-straze",
            #                 "zilinsky kraj, krasno nad kysucou",
            #                 "ceska republika, cz - vysocina", ],
        }
    elif graphsize == "small1":
        region_categories = {
            # 2276 at 96%
            'graph_dir_0': ["presovsky kraj, velky saris",
                            "presovsky kraj, vysoke tatry",
        ...
        region_categories = {
            # 69151 edges 60%
            'graph_dir_2': ["trnavsky kraj, holic",
    ...
    #                         "bratislavsky kraj, bratislava - vrakuna"],
    #         # 51805 edges 47%
    #         'graph_dir_1': ["kosicky kraj, kosice - sidlisko tahanovce",
    ...
    try:
        ...
        logger.error(f"Error FMMC experiments for all graphs: {e}")
