...
def new_run_experiment_pokec_semi(graphsize: str):
    # Set up directories and seeds for the experiment.
    experiment_name = f"new_pokec_semi_graphsize_{graphsize}"
    ...
    if graphsize == "small":
        region_categories = {
            ...
            # 6901 edges 71% maybe replace its too similar
            'graph_dir_1': ["bratislavsky kraj, bratislava - nove mesto",
                            "bratislavsky kraj, bratislava - raca",
                            "bratislavsky kraj, bratislava - lamac",
                            "bratislavsky kraj, bratislava - vajnory",],
            # # placeholder%
            # 'graph_dir_2': ["bratislavsky kraj, bratislava - nove mesto",
            #                 "bratislavsky kraj, bratislava - raca",
            #                 "bratislavsky kraj, bratislava - lamac",
            #                 "bratislavsky kraj, bratislava - vajnory", ],
        }
        ...
        region_categories = {
            ...
            'graph_dir_0': ["kosicky kraj, kosice - stare mesto",
                                    ...
                                    "trnavsky kraj, gbely",],
            # 33830 edges 74%
            'graph_dir_1': ["trnavsky kraj, holic",
                ...
                delayed(run_fmmc_experiment)(
                    ...
                    for graph_nr, (graph, experiment_graph_dir) in enumerate(generated_pokec_subgraphs_directories)
                        for selfloops in SELFLOOPS
                            for p in P_VALUES
                                for q in Q_VALUES)
        logger.info(f'Finished baseline FMMC experiments for all graphs')
    except Exception as e:
